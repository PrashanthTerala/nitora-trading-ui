...
export function GuidePage() {
  ...
  const { items, active, progress } = useLessonScroll(articleRef, hasDataService);
  return (
    <div className="mx-auto max-w-6xl xl:grid xl:grid-cols-[minmax(0,1fr)_208px] xl:gap-12">
      <ReadingProgressBar progress={progress} />
      <article ref={articleRef} className="prose-lesson mx-auto w-full min-w-0 max-w-(--container-lesson)">
        <h1 className="font-display text-h1 font-semibold tracking-tight">How Nitora Trading Academy works</h1>
        <p className="mt-3 text-body-lg text-ink-soft">The site has four rooms. Use them in this order the first time, then move between them freely.</p>

        <h2 id="1-learn" data-toc="2">1. Learn</h2>
        <p>
        ...
        <h2 id="2-simulator" data-toc="2">2. Simulator</h2>
        <p>
        ...
        {hasDataService ? (
          <>
            <h3 id="replaying-real-history" data-toc="3">Replaying real history</h3>
            <p>
          ...
          <>
            <h3 id="real-market-data" data-toc="3">Real market data</h3>
            <p>
        ...
        <h2 id="3-trainer" data-toc="2">3. Trainer</h2>
        <p>
          Two drills, played in sessions of ten rounds. <strong>Name the pattern</strong> shows a candle or chart pattern without its label and asks which it is, then links to the
          lesson that teaches it. <strong>Next candles</strong> shows a real-looking chart and asks whether the next few candles will close higher or lower; it is deliberately
          humbling and teaches that even good reads are only edges, not certainties. Each session ends with a score you can copy and share.
        </p>

        <h2 id="4-journal" data-toc="2">4. Journal</h2>
        <p>
        ...
        <h2 id="honesty-notes" data-toc="2">Honesty notes</h2>
        <ul>
        ...
        <p className="not-prose mt-10">
          <Link to="/learn" className={buttonClass({ size: 'lg' })}>
            Start learning
          </Link>
        </p>
      </article>
